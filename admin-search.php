...
<body>
  ...
  <div id="main">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> 問題</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">問題</a>
                                </li>
                                </ul>
                            </div>
                        </li>
    ...
    // 顯示結果
    echo '<br><span style="font-size: 20px;">消費超過100元顧客: ' . implode(', ', $customer_names) . '</span>';
    ?>
    ...
    $result = mysqli_query($con, "SELECT *
        FROM employees
        WHERE internal_external LIKE 'in%';");
    $employee_names = [];
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($employee_names as $index => $name): ?>
                <tr>
    ...
    $result = mysqli_query($con, "SELECT *
        FROM employees
        WHERE internal_external LIKE 'ex%';");
    $employee_names = [];
    ...
    <?php
$result = mysqli_query($con, "SELECT employee_id, name, salary
FROM employees
WHERE salary > 60000;");
$employees = [];
